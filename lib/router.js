...
// archived-moe (4chan)
router.get('/archived-moe/:keywords', require('./routes/archived-moe/index'));
router.get('/archived-moe/tnum/:tnum/keywords/:keywords', require('./routes/archived-moe/index'));
router.get('/archived-moe/tnum/:tnum', require('./routes/archived-moe/index'));
